...
| Docker escape | partial | Sandbox and Docker scanner plans avoid Docker socket, host HOME, credentials, and direct repo writable mounts. | Docker is not a complete malware sandbox; kernel, daemon, platform, and image trust risks remain. |
